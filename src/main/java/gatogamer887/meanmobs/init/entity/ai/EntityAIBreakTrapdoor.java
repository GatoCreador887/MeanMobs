...
public class EntityAIBreakTrapdoor extends EntityAITrapdoorInteract
{
    private int breakingTime;
    private int previousBreakProgress = -1;

    public EntityAIBreakTrapdoor(EntityLiving entityIn)
    {
        super(entityIn);
    }
    ...
    public boolean shouldExecute()
    {
        ...
        {
            BlockTrapDoor blockdoor = this.doorBlock;
            return true/*!this.entity.world.getBlockState(this.doorPosition).getValue(BlockTrapDoor.OPEN)*/;
        }
    }
    ...
    public boolean shouldContinueExecuting()
    {
        ...
        if (this.breakingTime <= 240 && this.entity.world.getBlockState(this.doorPosition).getBlock() instanceof BlockTrapDoor)
        {
            BlockTrapDoor blockdoor = this.doorBlock;

            if (/*!this.entity.world.getBlockState(this.doorPosition).getValue(BlockTrapDoor.OPEN) && */d0 < 4.0D)
            {
                flag = true;
                return flag;
            }
