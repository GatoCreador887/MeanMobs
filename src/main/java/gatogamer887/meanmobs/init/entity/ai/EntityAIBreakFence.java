...
public class EntityAIBreakFence extends EntityAIFenceInteract
{
    private int breakingTime;
    private int previousBreakProgress = -1;

    public EntityAIBreakFence(EntityLiving entityIn)
    {
        super(entityIn);
    }
    ...
    public boolean shouldContinueExecuting()
    {
        ...
        if (this.breakingTime <= 240 && this.entity.world.getBlockState(this.doorPosition).getBlock() instanceof BlockFence)
        {
            BlockFence blockdoor = this.doorBlock;
