...
public class EntityAIBreakDoorBetter extends EntityAIDoorInteractBetter
{
    ...
    public void updateTask()
    {
        ...
        {
        	this.breakingTime += (item instanceof ItemPickaxe/* && ToolMaterial.valueOf(((ItemPickaxe)item).getToolMaterialName()).getHarvestLevel() >= 1*/ ? 1 + ToolMaterial.valueOf(((ItemPickaxe)item).getToolMaterialName()).getEfficiency() / 6 : 1);
        }
