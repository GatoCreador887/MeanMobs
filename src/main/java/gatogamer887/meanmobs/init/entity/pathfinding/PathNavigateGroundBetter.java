package gatogamer887.meanmobs.init.entity.pathfinding;
...
public class PathNavigateGroundBetter extends PathNavigateGround
{
    private boolean shouldAvoidSun;

    public PathNavigateGroundBetter(EntityLiving entitylivingIn, World worldIn)
    {
    ...
    {
        this.nodeProcessor = new WalkNodeProcessorBetter();
