...
public class EntityMoveHelperBetter extends EntityMoveHelper
{
    ...
    public EntityMoveHelperBetter.Action action = EntityMoveHelperBetter.Action.WAIT;

    public EntityMoveHelperBetter(EntityLiving entitylivingIn)
    {
    ...
    {
        return this.action == EntityMoveHelperBetter.Action.MOVE_TO;
    }
    ...
    public void setMoveTo(double x, double y, double z, double speedIn)
    {
        ...
        this.posZ = z;
        this.speed = speedIn;
        this.action = EntityMoveHelperBetter.Action.MOVE_TO;
    }

    public void strafe(float forward, float strafe)
    {
        this.action = EntityMoveHelperBetter.Action.STRAFE;
        this.moveForward = forward;
        this.moveStrafe = strafe;
        this.speed = 0.25D;
    }

    public void read(EntityMoveHelperBetter that)
    {
    ...
    {
        if (this.action == EntityMoveHelperBetter.Action.STRAFE)
        {
            ...
            this.action = EntityMoveHelperBetter.Action.WAIT;
        }
        else if (this.action == EntityMoveHelperBetter.Action.MOVE_TO)
        {
            this.action = EntityMoveHelperBetter.Action.WAIT;
            ...
            if (this.entity.isPotionActive(MobEffects.JUMP_BOOST))
            {
            	d4 += this.entity.getActivePotionEffect(MobEffects.JUMP_BOOST).getAmplifier() * 0.625D;
            }
        ...
        else if (this.action == EntityMoveHelperBetter.Action.JUMPING)
        {
            this.entity.setAIMoveSpeed((float)(this.speed * this.entity.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getAttributeValue()));
